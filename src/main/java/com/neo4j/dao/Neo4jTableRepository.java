...
public interface Neo4jTableRepository extends Neo4jRepository<TableGraph, Long> {
    ...
    @Query("MATCH (a:TABLE)-[r]-(b:TABLE) WHERE a.fullCode={fullCode} return distinct a.db,a.code,a.name,r.source,r.sname,r.stag,b.db,b.code,b.name,r.target,r.tname,r.ttag ")
